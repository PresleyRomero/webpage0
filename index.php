...
<head>
	...
	<link rel="stylesheet" type="text/css" href="view/frontend/css/style.css">
  ...
  <style>
    ...
    @media screen and (max-width: 670px){ /* cambiar cuando screen sea de 670 px de ancho o menos*/
      header{
        min-height: 500px;
      }
    }
    .section{
      padding-top: 4vw; /*relleno(espacio entre el borde y su contenido del elemento) del 4% relativo al ancho ventana (Viewport Width) */
      padding-bottom: 4vw;
    }
    /*margin(espacio alrededor del elmento)*/
    /*padding(espacio dentro del elmento)*/
...
<body>
    ...
    <nav class="nav-wrapper transparent">
      <div class="container">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li><a href="view/login2.php">Login</a></li>
  ...
  <!-- photo / grid -->
  <section class="container section scrollspy" id="photos"> <!--contenido centrado y margen, scrollspy: se ve el desplazamiento al linkear esta seccion-->
    <div class="row">
  ...
  <div class="parallax-container">
    <div class="parallax">
      <img src="assets/img/photo1.png" alt="" class="responsive-img">
    </div>
  </div>
  ...
  <section class="section container scrollspy" id="services">
    <div class="row">
      ...
      <div class="col s12 l6 offset-l2">
        ...
        <ul class="tabs">
          <li class="tab col s6">
            <a href="#photography" class="active indigo-text text-darken-4">Fotografía</a>
          </li>
          <li class="tab col s6">
            <a href="#editing" class="indigo-text text-darken-4">Edición</a>
          </li>
        </ul>
        <div id="photography" class="col s12">
            <p class="flow-text indigo-text text-darken-4">Fotografía</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum at lacus congue, suscipit elit nec, tincidunt orci.</p>
            <p>Mauris dolor augue, vulputate in pharetra ac, facilisis nec libero. Fusce condimentum gravida urna, vitae scelerisque erat ornare nec.</p>
        </div>
        <div id="editing" class="col s12">
            <p class="flow-text indigo-text text-darken-4">Edición</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum at lacus congue, suscipit elit nec, tincidunt orci.</p>
            <p>Mauris dolor augue, vulputate in pharetra ac, facilisis nec libero. Fusce condimentum gravida urna, vitae scelerisque erat ornare nec.</p>
        </div>
        </div>
  ...
  <footer class="page-footer grey darken-3">
    ...
    <div class="footer-copyright grey darken-4">
      <div class="container center-align">&copy; 2018 Presley Romero</div>
    </div>
  </footer>

  <!-- Compiled and minified JavaScript -->
	<script  src="view/frontend/js/jquery-3.3.1.min.js"></script>
